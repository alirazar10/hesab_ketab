...
class _WaterState extends State<Water> {
  ...
  Widget build(BuildContext context) {
    var _paddings = EdgeInsets.symmetric(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => AddWaterMeter()));
                          },
                        ),
                      ),
                      Text('ثبت میتر آب',
                          style:
                              myTextStyle(color: Colors.black, fontSize: 17.0)),
                      Container(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => Watermeterlist()));
                          },
                        ),
                      ),
                    ],
                      ...
                      Container(
                        ...
                        child: IconButton(
                          ...
                          icon: Icon(FontAwesomeIcons.plus,
                              color: Color(0xFFFF5722), size: 27.0),
                          onPressed: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => AddWaterNeibors()));
                          },
                        ),
                      ),
                      Text('همسایه‌های مشترک در آب',
                          style: myTextStyle(
                      ...
                      Container(
                        ...
                        child: IconButton(
                          ...
                          icon: Icon(FontAwesomeIcons.ellipsisH,
                              color: Color(0xff00BCD4), size: 24.0),
                          onPressed: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => WaterNeighborList()));
                          },
                        ),
                      ),
                    ],
